...
Display name for the layer (supports localization).
...
- Simple string: `"My Layer"`
- Localized object: `{ en: "My Layer", fr: "Ma Couche" }`
...
// Localized
metadataAccessPath: {
  en: "https://example.com/en/wms",
  fr: "https://example.com/fr/wms",
};
```
...
```typescript
{
  ...
  layerName: { en: "Weather Data" },
  listOfLayerEntryConfig: [
    { layerId: "temperature", layerName: { en: "Temperature" } },
    { layerId: "precipitation", layerName: { en: "Precipitation" } }
  ]
}
```
...
```typescript
{
  ...
  geoviewLayerType: "ogcWms",
  geoviewLayerName: { en: "Weather Forecast" },
  metadataAccessPath: "https://example.com/wms",
  isTimeAware: true,
  serviceDateFormat: "YYYY-MM-DDTHH:mm:ss",
...
```typescript
{
  ...
  geoviewLayerName: { en: "ESRI Features" },
  metadataAccessPath: "https://example.com/FeatureServer/0",
  listOfLayerEntryConfig: [
    {
      layerId: "0",
      layerName: { en: "Features" },
      source: {
        featureInfo: {
          queryable: true,
          outfields: ["*"],
...
```typescript
{
  ...
  geoviewLayerName: { en: "CSV Points" },
...
```typescript
{
  ...
  geoviewLayerType: "geoJSON",
  geoviewLayerName: { en: "Styled Features" },
  metadataAccessPath: "/data/features.geojson",
  initialSettings: {
    visible: true,
    states: {
...
```typescript
{
  ...
  geoviewLayerName: { en: "ESRI Service" },
  metadataAccessPath: "https://example.com/MapServer",
  listOfLayerEntryConfig: [
    {
      layerId: "group-1",
      layerName: { en: "Administrative" },
      listOfLayerEntryConfig: [
        {
          layerId: "0",
          layerName: { en: "Provinces" },
          initialSettings: {
            minZoom: 0,
            maxZoom: 8,
          },
