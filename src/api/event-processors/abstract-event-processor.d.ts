...
export declare abstract class AbstractEventProcessor {
     ...
     */
    protected static helperPropagateArrayStoreBatch(mapId: string, layerDataArray: TypeLayerData[], batchPropagationObject: BatchedPropagationLayerDataArrayByMap, timeDelayBetweenPropagations: number, onSetLayerDataArray: (layerDataArray: TypeLayerData[]) => void, traceProcessorIndication?: string, layerPathBypass?: string, onResetBypass?: (layerPath: string) => void): Promise<void>;
}
