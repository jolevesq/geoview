...
export declare class GeoviewRenderer {
     ...
     * @returns {Promise<TypeVectorLayerStyles>} A promise that the layer styles are processed.
     */
    getLegendStyles(layerConfig: AbstractBaseLayerEntryConfig & {
     ...
     */
    getFeatureStyle(feature: Feature, layerConfig: AbstractBaseLayerEntryConfig | VectorTilesLayerEntryConfig | VectorLayerEntryConfig): Style | undefined;
    /** ***************************************************************************************************************************
     ...
     */
    getFeatureCanvas(feature: Feature, layerConfig: AbstractBaseLayerEntryConfig | VectorTilesLayerEntryConfig | VectorLayerEntryConfig): Promise<HTMLCanvasElement | undefined>;
    /** ***************************************************************************************************************************
