...
import { TypeFeatureInfoEntryPartial, codedValueType, rangeDomainType } from '@/geo/utils/layer-set';
import { TypeLayerEntryConfig, TypeListOfLayerEntryConfig } from '@/geo/map/map-schema-types';
 ...
 */
export declare function commonProcessFeatureInfoConfig(this: EsriDynamic | EsriFeature | EsriImage, layerConfig: EsriFeatureLayerEntryConfig | EsriDynamicLayerEntryConfig | EsriImageLayerEntryConfig): void;
/** ***************************************************************************************************************************
 ...
 *         EsriImageLayerEntryConfig} layerConfig The layer entry to configure.
 */
export declare function commonProcessInitialSettings(this: EsriDynamic | EsriFeature | EsriImage, layerConfig: EsriFeatureLayerEntryConfig | EsriDynamicLayerEntryConfig | EsriImageLayerEntryConfig): void;
/** ***************************************************************************************************************************
